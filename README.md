...
Version 1.0
==================================================================
The researchers on this project were:
...
The original dataset from UCI Machine Learning Repository includes the following files of data:
...
- 'train/Inertial Signals/total_acc_x_train.txt': The acceleration signal from the smartphone accelerometer X axis in standard 
                             gravity units 'g'. Every row shows a 128 element vector. The same description applies for the 
